...
var McsItemDetailComponent = /** @class */ (function () {
    function McsItemDetailComponent(route, router, mcService, userService) {
        this.route = route;
        this.router = router;
        this.mcService = mcService;
        this.userService = userService;
    ...
    McsItemDetailComponent.prototype.onLike = function (choise) {
