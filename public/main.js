...
var ScrollingDirective = /** @class */ (function () {
    ...
    ScrollingDirective.prototype.getCoords = function (elem) {
        var box = elem.getBoundingClientRect();
        return {
