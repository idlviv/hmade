...
module.exports = "<p>\r\n  {{data.message}}\r\n</p>\r\n<button mat-button color=\"danger\" (click)=\"onClose(true, data.payload)\">Так</button>\r\n<button mat-button color=\"primary\" (click)=\"onClose(false, null)\">Ні</button>"
