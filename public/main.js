...
var CommentsComponent = /** @class */ (function () {
    ...
    CommentsComponent.prototype.sendComment = function () {
        ...
        this.socialService.addComment(this.parent_id, this.parent_category, comment).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["mergeMap"])(function (result) {
            if (result) {
                return _this.socialService.getComments(_this.parent_id, -1, 0, 10, false);
            }
            else {
        ...
        }, function (err) { return console.log('send Comment err', err); });
    };
    __decorate([
...
var SocialService = /** @class */ (function () {
    ...
    SocialService.prototype.getComments = function (parent_id, sort, skip, limit, displayFilter) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content-Type': 'application/json',
            }),
