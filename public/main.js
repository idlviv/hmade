...
let SharedService = class SharedService {
    constructor(http) {
        this.http = http;
        this._shareEvent = new rxjs__WEBPACK_IMPORTED_MODULE_2__["ReplaySubject"](1);
        this.shareEvent$ = this._shareEvent.asObservable();
        this._eventToReloadComments = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    sendFeedbackMessage(feedback, recaptcha) {
        const httpOptions = {
            ...
            params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpParams"]({ fromObject: {
                    recaptcha
                } })
        };
