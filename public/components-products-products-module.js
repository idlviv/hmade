...
var ProductsDetailComponent = /** @class */ (function () {
    ...
    ProductsDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(function (paramMap) {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(_this.productService.getProductById(_this.product_id, 'products', true), _this.productService.getProductsByParent(_this.category_id, 'products', true));
        }))
            .subscribe(function (result) {
...
var ProductsListComponent = /** @class */ (function () {
    ...
    ProductsListComponent.prototype.refreshProducts = function () {
        var _this = this;
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(function (param) {
            ...
            if (!_this.children.length) {
                ...
                return _this.productService.getProductsByParent(_this.category_id, 'products', true);
            }
            else {
