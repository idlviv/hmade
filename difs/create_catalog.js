      ...
      { _id: 'products', name: 'Мої роботи', ancestors: ['home', 'common'], parent: 'common',
        ...
        { _id: 'decorative', ancestors: ['home', 'common', 'products'], parent: 'products', order: 4,
          ...
          { _id: 'weddingDecor', ancestors: ['home', 'common', 'products', 'decorative'], parent: 'decorative', order: 1,
            assets: ['default_product'], name: 'Весільний декор', description: ''},
          { _id: 'fotoZones', ancestors: ['home', 'common', 'products', 'decorative'], parent: 'decorative', order: 2,
            assets: ['default_product'], name: 'Фотозони', description: ''},
        ...
        { _id: 'scrapbooking', ancestors: ['home', 'common', 'products'], parent: 'products', order: 6,
          ...
          { _id: 'albums', ancestors: ['home', 'common', 'products', 'scrapbooking'], parent: 'scrapbooking', order: 1,
            assets: ['default_product'], name: 'Альбоми', description: ''},
          { _id: 'cards', ancestors: ['home', 'common', 'products', 'scrapbooking'], parent: 'scrapbooking', order: 2,
            assets: ['default_product'], name: 'Листівки', description: ''},

  { _id: 'mk', name: 'МК', ancestors: ['home', 'common'], parent: 'common',
        auth: 'casual', order: 3, assets: [''],description: ''},
